<template>
  <el-container style="padding: 50px; background-image: url('../../static/img/homepage_bg.jpg');" direction="vertical">
  <!-- <el-container style="padding: 50px" direction="vertical" class="bg"> -->
    <el-row :gutter="5">
      <el-col :span="8">
